if (!customElements.get('quick-view-modal')) {
    customElements.define('quick-view-modal', class QuickViewModal extends ModalDialog {
      ...
      show(opener) {
        ...
        opener.querySelector('.svg-search1').classList.add('hidden');
        opener.querySelector('.svg-spinner').classList.remove('hidden');
       ...
       // opener.querySelector('.loading-overlay__spinner').classList.remove('hidden');
        ...
        fetch(opener.getAttribute('data-product-url'))
          ...
          .finally(() => {
            ...
            opener.querySelector('.svg-search1').classList.remove('hidden');
            opener.querySelector('.svg-spinner').classList.add('hidden');
